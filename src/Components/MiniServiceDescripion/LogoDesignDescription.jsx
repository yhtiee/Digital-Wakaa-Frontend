        ...
        <div className="container descripion__container">
            <div className="description__wrapper">
                <div className="des__top">
                    <h2>Are Logos Even Important? Of Course</h2>
                    <p>A powerful logo is the cornerstone of a successful brand. It's the face of your business, representing your values, mission, and identity. A well-crafted logo establishes credibility, builds trust, and leaves a memorable impression on your audience. </p>
                    <p>In a crowded marketplace, a unique and distinctive logo helps your business stand out from competitors. By creating a strong visual identity, your logo can help attract attention and make a lasting impression on potential customers.</p>
                    <p>We combine creativity and research to create a unique and memorable logo that perfectly represents your business. From initial concept development to final polish, our talented designers ensure every detail is carefully considered, resulting in a logo that stands out in today's competitive market.</p>
                </div>
                <hr />
...
export default LogoDesignDescription